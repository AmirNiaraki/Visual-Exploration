...
def power_cost(state_ijk,next_state_ijk,wind_layer):
    movement=np.array([next_state_ijk[1]- state_ijk[1], next_state_ijk[0]-state_ijk[0]])
...
#    np.save("./)
    print('Path:',path,'actions:', action_list)
    breaker.value = 0
...
#            Rewards_Sarsa[e]=r_sarsa    
    ...
    print("Rewards accross episodes:",Rewards_Sarsa[:], "optimal path", Path_sarsa_opt)
